...
[![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fegondalia%2FSAP-HANA-ARM%2Fmaster%2Fazuredeploy.json)
## Machine Info
...
## Installation Media
Installation media for SAP HANA should be downloaded and placed in the SapBits folder. You will need to provide the URI for the container where they are stored, for example https://yourBlobName.blob.core.windows.net/yourContainerName. For more information on how to upload files to Azure please go [here](https://github.com/egondalia/SAP-HANA-ARM/blob/master/UploadToAzure.md)  Specifically you need to download SAP package 51053061, which should consist of four files:
```
51053061_part1.exe
51053061_part2.rar
51053061_part3.rar
...
![SapBits Image](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/Structure1.png)

The following files should be present inside the SapBits folder:

![HANA Image](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/Structure2.png)
...
![HANA Studio Image](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/Structure3.png)

## Deploy the Solution
### Deploy from the Portal

To deploy from the portal using a graphic interface you can use the [![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fegondalia%2FSAP-HANA-ARM%2Fmaster%2Fazuredeploy.json) button to bring up the template in your subscription and fill out the parameters.
...
![Directories](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/directories.png)
...
![Directories2](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/directories2.png)

Select the option of "Build your own template in the editor"

![Directories3](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/directories3.png)

Copy the contents from the azuredeploy.json [file](https://raw.githubusercontent.com/egondalia/SAP-HANA-ARM/master/azuredeploy.json) and paste them into the template editor, click Save.

![Directories4](https://github.com/egondalia/SAP-HANA-ARM/blob/master/media/directories4.png)
